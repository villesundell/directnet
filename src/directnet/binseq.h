...
namespace DirectNet {
    ...
    class BinSeq : public std::vector<char> {
        public:
        BinSeq();
        BinSeq(const BinSeq &copy);
        BinSeq(const std::string &copy);
        ...
        inline int find(const std::string& str, int index) const
        {
        ...
        inline void push_back(const std::string &str) { push_back(str.c_str()); }
        inline void push_back(const char chr) {
            ((std::vector<char> *) this)->pop_back();
            ((std::vector<char> *) this)->push_back(chr);
            ((std::vector<char> *) this)->push_back(0);
        }
        ...
        // operators
        inline bool operator==(const BinSeq &comp) const { return (*((std::vector <char> *) this)) == comp; }
        inline bool operator!=(const BinSeq &comp) const { return (*((std::vector <char> *) this)) != comp; }
        inline BinSeq &operator+=(const BinSeq &add) { push_back(add.c_str(), add.size()); }
        inline BinSeq &operator+=(const std::string &add) { push_back(add.c_str()); return *this; }
        inline BinSeq &operator+=(char *add) { push_back(add); return *this; }
        inline BinSeq &operator+=(char add) { push_back(add); return *this; }
        inline char &operator[](int i) const { return (*((std::vector <char> *) this))[i]; }
        inline operator std::string() const {
            std::string a(c_str(), size());
            return a;
        }
        ...
        // accessors
        inline int size() const { return ((std::vector <char> *) this)->size() - 1; }
    };
}
